...
namespace 
        {
        //constant for accessing a quaternion's X component
        const unsigned char QX = 0;
        //constant for accessing a quaternion's Y component
        const unsigned char QY = 1;
        //constant for accessing a quaternion's Z component
        const unsigned char QZ = 2;
        //constant for accessing a quaternion's scalar component
